...
SLACK_WEBHOOK_SECRET = [ENTER-YOUR-API-CODES]
TWILIO_NUMBER =[TWILIO-NUMBER]
USER_NUMBER = [YOUR-NUMBER]
 
app = Flask(__name__)
slack_client = SlackClient(os.environ.get([SLACK-CODE], None))
TWILIO_ACCOUNT_SID = [TWILIO-CREDENTIALS]
TWILIO_AUTH_TOKEN = [TWLIO-CREDENTIALS]
